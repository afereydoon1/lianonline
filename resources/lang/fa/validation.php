...
return [
    ...
    */
    ...
    'captcha_code' => 'کد امنیتی اشتباه است.',
    'old_password_is_wrong' => 'رمزعبور فعلی صحیح نیست.',
    'amount_not_enough' => 'میزان مبلغ درخواستی از موجودی بیشتر است.',
    'min_amount_error' => 'حداقل مبلغ مورد نیاز برای درخواست :price میباشد.',
    'no_finance_info_in_profile' => 'لطفا اطلاعات بانکی خود، شامل نام بانک، شماره کارت، تصویر کارت ملی و تصویر کارت بانکی خود را تکمیل نمایید.',
    'withdrawal_not_register' => 'درخواست ثبت نشد',
    'transaction_not_register' => 'تراکنش ثبت نشد',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'attributes' => [
        ...
        'key' => 'کد',
        'level' => 'سطح',
        'can_list' => 'امکان نمایش',
        'can_add' => 'امکان افزودن',

        ...
        <div class="table-responsive">
            ...
            <table class="lian-table table table-hover table-borderless border-0"  v-if="files.length">
                ...
                <tr v-for="(file, index) in files" :key="file.id">
                    ...
                    <td class="text-center">
                        <span v-show="file.download_path != undefined && file.id != value"
                        @click.prevent="$emit('input',file.id)"
                        class="btn btn-outline-warning btn-sm">شاخص شود</span>
                        <span v-show="file.id == value"
                        class="text-success">تصویر شاخص</span>
                    </td>
                </tr>
                </tbody>
            </table>

    ...
    <div>
        <div class="row">
            <div class="col-sm-7 text-right pt-2">
                <h2 class="h4 mb-4 text-info">لیست ادمین ها</h2>
            </div>
            ...
            <table class="lian-table table table-hover table-borderless border-0">
                ...
                <tr v-for="(record, index) in records.data">
                    ...
                    <td class="text-center">
                        <router-link :to="{name: 'admins.edit', params: {'id': record.id}}" class="btn btn-sm btn-success">
                            <span>ویرایش</span>
                        </router-link>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                'records': new Records(),
                'base_url': '/management/api/admin/list',
                'filters': {},
                'is_filtering': false,
                'errors': new Errors(),
                'message': ''
        ...
        methods : {
            ...
            remove(id) {
                ...
                if (answer) {
                    window.axios.post('/management/api/admin/delete/' + id, {})
                        .then(response => {
                            if (response.data.returnCode === 0)
                            {

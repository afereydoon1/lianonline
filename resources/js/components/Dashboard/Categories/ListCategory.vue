    ...
    <div>
        <div class="row">
            ...
            <div class="col-sm-5 text-left">
                <router-link :to="{name: 'category.create'}" class="btn btn-info m-1 item ">
            ...
            <table class="lian-table table table-hover table-borderless border-0">
                ...
                <tr v-for="(record, index) in records.data">
                    ...
                    <td class="text-center">
                        <router-link :to="{name: 'category.edit', params: {'id': record.id}}" class="btn btn-sm btn-success">
                            <span>ویرایش</span>
                        </router-link>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                'records': new Records(),
                'base_url': '/management/api/category/list',
                'filters': {},
                'is_filtering': false,
                'errors': new Errors(),
                'message': ''
        ...
        methods : {
            ...
            remove(id) {
                ...
                if (answer) {
                    window.axios.post('/management/api/category/delete/' + id, {})
                        .then(response => {
                            if (response.data.returnCode === 0)
                            {

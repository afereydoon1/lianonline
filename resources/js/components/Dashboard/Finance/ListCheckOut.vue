    ...
    <div>
        <div class="row">
            <div class="col-sm-7 text-right pt-2">
                <h2 class="h4 mb-4 text-info">لیست درخواست تسویه حساب ها</h2>
            </div>
        </div>
        ...
        <div v-if="this.records.total > 0">
            <table class="lian-table table table-hover table-borderless border-0">
                ...
                <tr v-for="(record, index) in records.data" :key="record.id">
                    ...
                    <td class="text-center">درخواست تسویه حساب کاربر</td>
                    ...
                    <td class="text-center">
                        <router-link :to="{name: 'finance.checkout.edit', params: {'id': record.id}}" class="btn btn-sm btn-success">
                            <span>مشاهده</span>
                        </router-link>
                    </td>
                </tr>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                'records': new Records(),
                'base_url': '/management/api/checkout/list',
                'filters': {},
                'is_filtering': false,
                'errors': new Errors(),
                'message': ''
